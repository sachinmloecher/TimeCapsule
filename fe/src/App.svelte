  ...
  <div class="footer">
    ...
    >
      {#if view === Views.RECORD}
        <svg class='bottom-svg' xmlns="http://www.w3.org/2000/svg" height="48" width="48" viewBox="0 0 48 48"
          ><path
...
<style>
  ...
  .container {
    ...
    height: 100vh;
    display: grid;
    grid-template-rows: 2fr 10fr 1.25fr;
  ...
  .header {
    ...
    align-items: center;
    flex: 1;
    background-image: linear-gradient(to top, rgba(255, 255, 255, 0.109), rgba(245, 169, 27));
  }
